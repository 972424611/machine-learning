...
def traindata():
    ...
    for i in range(0,num):
        ...
        trainarr[i,:]=datatoarray("E:\pythonResult\knn\\traindata/"+thisfname)
...
#测试
thisdata=datatoarray("E:\pythonResult\knn\\testdata/8_90.txt")
...
#识别多个手写体数字（批量测试）
testfileall=listdir("E:\pythonResult\knn\\testdata")
num=len(testfileall)
x=0
for i in range(0,num):
    ...
    #print(thislabel)
    thisdataarray=datatoarray("E:\pythonResult\knn\\testdata/"+thisfilename)
